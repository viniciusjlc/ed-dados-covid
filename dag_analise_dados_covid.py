...
def obter_porcentagem_mulheres_homens_covid():
    ...
    sql = "insert into est_covid_genero (sexo, quantidade, porcentagem) values('{}',{},{})".format('F', total_mulheres, porcentagem_mulheres)
    cursor.execute(cursor.mogrify(sql))

    sql = "insert into est_covid_genero (sexo, quantidade, porcentagem) values('{}',{},{})".format('M', total_homens, porcentagem_homens)
    cursor.execute(cursor.mogrify(sql))
...
def obter_porcentagem_recuperado_obitos_covid():
    ...
    sql = "insert into est_covid_recuperados_obito (situacao, quantidade, porcentagem) values('{}',{},{})".format('RECUPERADOS', total_recuperados, porcentagem_recuperados)
    cursor.execute(cursor.mogrify(sql))

    sql = "insert into est_covid_recuperados_obito (situacao, quantidade, porcentagem) values('{}',{},{})".format('ÓBITO', total_obitos_covid, porcentagem_obitos)
    cursor.execute(cursor.mogrify(sql))

    sql = "insert into est_covid_recuperados_obito (situacao, quantidade, porcentagem) values('{}',{},{})".format('ÓBITO OUTRAS CAUSAS', total_obitos_outros, porcentagem_obtos_outros)
    cursor.execute(cursor.mogrify(sql))
...
def obter_porcentagem_pessoas_covid_com_comorbidades():
    ...
    sql = "insert into est_covid_comorbidades (possui_comorbidades, quantidade, porcentagem) values('{}',{},{})".format('N', total_sem_comorbidade, porcentagem_total_sem_comorbidade)
    cursor.execute(cursor.mogrify(sql))

    sql = "insert into est_covid_comorbidades (possui_comorbidades, quantidade, porcentagem) values('{}',{},{})".format('S', total_com_comorbidade, porcentagem_total_com_comorbidade)
    cursor.execute(cursor.mogrify(sql))
